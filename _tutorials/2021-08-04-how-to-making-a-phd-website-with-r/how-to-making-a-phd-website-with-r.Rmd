...
description: |
  In this tutorial I describe how to create a Distill website with R Studio and Github Pages. I also describe how I created the profile homepage with the `postcards` package and made some styling (CSS) adjustments.
author:
...
preview: images/new-distill-project.png
---
